...
<section class="packages" id="packages">
    ...
    <div class="box-container">
        <div class="box">
            <img src="pic/sof_omar.png" alt="">
            <div class="content">
                <h3><i class="fas fa-map-marker-alt"></i> sof omar</h3>
                ...
                <div class="price">$50.00 <span>$70.00</span></div>
        ...
        <div class="box">
            <img src="pic/ras dashen mountain.png" alt="">
            <div class="content">
                <h3><i class="fas fa-map-marker-alt"></i> ras dashen</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
        ...
        <div class="box">
            <img src="pic/aba jifar.png" alt="">
            <div class="content">
                <h3><i class="fas fa-map-marker-alt"></i> abba jifar capitol</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
        ...
        <div class="box">
            <img src="pic/lalibela .png" alt="">
            <div class="content">
                <h3><i class="fas fa-map-marker-alt"></i> lalibela church</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
        ...
        <div class="box">
            <img src="pic/abay.png" alt="">
            <div class="content">
                <h3><i class="fas fa-map-marker-alt"></i> abay dam</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
        ...
        <div class="box">
            <img src="pic/bale mountain.png" alt="">
            <div class="content">
                <h3><i class="fas fa-map-marker-alt"></i>bale mountain</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
